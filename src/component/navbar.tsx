                ...
                <div className="flex justify-between py-5 px-5 md:px-10 w-full">
                    ...
                    <div className="flex justify-center items-center gap-10">
                        ...
                        <div className="flex gap-3">
                            <Link className="text-sm px-6 py-2 bg-[#D9D9D9] hover:bg-[#c1c1c1] rounded-2xl text-[#24221D] flex justify-center items-center" href={"https://bit.ly/SurveyRumi"} target='blank' role="button">Formulir</Link>
