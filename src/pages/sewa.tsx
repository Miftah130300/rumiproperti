...
export default function Property() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setFilteredProperties((data.data || []).filter((item: Properti) => item.tipeProperti === "Sewa"));
            } catch (error) {
    ...
    const handleFilter = () => {
        const filtered = properti.filter(item => {
            const isForSale = item.tipeProperti === "Sewa";
    ...
    return (
        <>
            <Head>
                <title>Jual dan Sewa Rumah, Apartemen, Tanah, dan Kosan | Rumi Properti</title>
                <meta name="robots" content="index, follow" />
                <meta property="og:title" content="Tipe Properti Rumi Properti" />
