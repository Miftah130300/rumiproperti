...
export default function DetailProperti() {
    ...
    return (
        <>
            <Head>
                <title>{selectedProperti.title}</title>
                <meta name="robots" content="index, follow" />
                <meta property="og:title" content={selectedProperti.title} />
                <meta property="og:description" content={selectedProperti.description} />
                <meta property="og:image" content={selectedProperti.bannerProperty.formats.medium?.url} />
                <meta property="og:url" content={`https://rumiproperti.com/properti/${selectedProperti.title}`} />
            </Head>
            <div>
                <Navbar />
